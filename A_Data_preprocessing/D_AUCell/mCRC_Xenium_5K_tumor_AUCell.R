...
seurat_obj_path = '/diskmnt/Projects/MetNet_analysis/Colorectal/epeng/Xenium/Xenium_5K/subset_objects/mCRC_Xenium_N26_tumor_layersjoined.qs'
...
output_dir <- "/diskmnt/Projects/MetNet_analysis_2/Colorectal/Analysis/Xenium/Tumor_genesets/" 
file_prefix <- "mCRC_Xenium5K_N26_tumor"
...
# Load seurat obj
seurat_obj = qread(seurat_obj_path)
...
# Get RNA matrix
tumor_rna_matrix <- seurat_obj[['Xenium']]$'counts'
