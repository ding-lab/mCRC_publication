#!/usr/bin/env Rscript
# Same as build_infercnv_state_summary_from_pred.R but:
#   - Default OUT_ROOT: 20241001_inferCNV_state_summary (cohort-wide output dir)
#   - If SAMPLES env is unset/empty, auto-discover all sample folders under INFERCNV_ROOT
#     that contain both required files under <id>/out/
#
# Run:
#   Rscript build_infercnv_state_summary_from_pred_all_samples.R
# Optional:
#   SAMPLES="CM329C1-S1,HT225C1-Th1" Rscript ...   # subset
#   INFERCNV_ROOT=... SEURAT_RDS=... OUT_ROOT=... Rscript ...
# Mixed inferCNV run dates (comma-separated sample=root):
#   INFERCNV_ROOT_OVERRIDES="HT225C1-Th1=/diskmnt/.../20241002_inferCNV_results"
...
OUT_ROOT <- Sys.getenv(
  "OUT_ROOT",
  unset = "/diskmnt/Projects/MetNet_analysis_2/Colorectal/InferCNV/20241001_inferCNV_state_summary"
)
