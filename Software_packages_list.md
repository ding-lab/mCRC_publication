...
- **R Version**: R 4.0 or higher (grid v4.4.3 detected)
- **Seurat**: v5.3.0
- **Python**: v3.13.3 (packaged by conda-forge) - Used for Xenium Banksy clustering and spatial analysis
...
Most R packages can be installed from CRAN or Bioconductor:
```r
...
For a complete tabular list of all packages and their versions, see `packages_with_versions.txt` or `packages_versions_table.md` generated by `list_package_versions.R`.
